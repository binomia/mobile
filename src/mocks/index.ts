import { askingForMoneyIcon, withdrawIcon, depositIcon, limitIcon, mailIcon, mastercardLogo, notificacionIcon, phoneIcon, privacyIcon, receiveIcon, sendMoneyIcon, soportIcon, userIcon, visaLogo, whatsappIcon, claroLogo, articeLogo } from "@/src/assets";
import { SUPPORT_EMAIL } from "@/src/constants";
import { FORMAT_CURRENCY, FORMAT_LIMIT, FORMAT_PHONE_NUMBER } from "@/src/helpers";
import { AccountLimitsType, AccountType, GlobalContextType } from "@/src/types";
import { cancelIcon, checked, pendingClock } from '@/src/assets';
