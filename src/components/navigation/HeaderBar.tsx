...
export const HomeHeaderRight: React.FC = () => {
    ...
    return (
        <VStack>
            <Pressable bg={colors.lightGray} w={"40px"} h={"40px"} alignItems={"center"} justifyContent={"center"}
                       borderRadius={100} _pressed={{opacity: 0.5}} onPress={onPress}>
...
export const TransactionsHeaderRight: React.FC = () => {
    ...
    return (
        <VStack>
            <Pressable _pressed={{opacity: 0.5}} bg={colors.lightGray} w={"40px"} h={"40px"} alignItems={"center"}
                       justifyContent={"center"} borderRadius={100} onPress={() => setShowBottomSheet(true)}>
                <Image alt='logo-image' w={"22px"} h={"22px"} source={recurrenceIcon}/>
            </Pressable>
            <RecurrenceTransactions open={showBottomSheet} onCloseFinish={() => setShowBottomSheet(false)}
                                    onSendFinish={() => setShowBottomSheet(false)}/>
        </VStack>
    )
}
    ...
    return (
        <HStack alignItems={"center"}>
            {transaction?.profileImageUrl ?
                <Image borderRadius={100} resizeMode='contain' alt='logo-image' w={scale(35)} h={scale(35)}
            ...
            <VStack ml={"10px"} alignItems={"center"}>
                <Heading textTransform={"capitalize"} fontSize={scale(18)}
...
export const TopupsRight: React.FC = () => {
    ...
    return (
        <Pressable w={"35px"} h={"35px"} alignItems={"center"} justifyContent={"center"} _pressed={{opacity: 0.5}}
                   bg={colors.lightGray} borderRadius={100} onPress={onPress}>
